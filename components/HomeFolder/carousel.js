...
export default function Carousel(){
  ...
  <div className="row d-flex justify-content-center">
    <div className="col-md-10 col-xl-8 text-center">
      <h3 className="mb-4">Reviews & Testimonials</h3>
  ...
  <div className="row text-center">
    <div className="col-md-4 mb-5 mb-md-0">
      ...
      <h6 className="text-primary mb-3">German</h6>
      <p className="px-xl-3">
    ...
    <div className="col-md-4 mb-5 mb-md-0">
      ...
      <h6 className="text-primary mb-3">American</h6>
      <p className="px-xl-3">
    ...
    <div className="col-md-4 mb-0">
      ...
      <h6 className="text-primary mb-3">French</h6>
      <p className="px-xl-3">
